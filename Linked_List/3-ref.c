/*Write a C program using singly linked lists to:
Read polynomials from the user by entering terms as (coefficient, power).


Display the polynomial in standard mathematical form (e.g., 3x^3 + 2x^2 + 1).


Add two polynomials and display the resulting polynomial.


Multiply two polynomials and display the resulting polynomial.*/
